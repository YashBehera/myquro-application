  ...
  const handleSubmit = async () => {
    ...
    if (!description.trim()) {
      showAlertModal({
        ...
        subtitle: 'Please describe the joining bonus issue before submitting.',
    ...
    showAlertModal({
      type: 'success_online',
      title: 'Ticket Raised 🎉',
      subtitle: `Your joining bonus ticket (#${ticketId}) has been submitted successfully. Our team will verify and resolve it within 2-4 hours.`,
