  ...
  const handleNotifyMe = () => {
    if (!email) {
      showAlertModal({
        ...
        subtitle: 'Please enter your email address to receive EV launch updates.',
    ...
    showAlertModal({
      type: 'success_online',
      title: 'Subscribed 🎉',
      subtitle: "Thank you! We'll notify you as soon as EV Rental program launches in your zone.",
  ...
  return (
    ...
    >
      ...
      <View style={[styles.topBar, { paddingTop: Math.max(insets.top, 12) }]}>
        ...
        <Text style={styles.headerTitle}>Rent Electric Vehicle</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      >
        ...
        {/* COVERED MOTORCYCLE GRAPHIC */}
        <View style={styles.graphicContainer}>
          <Image
            source={require('../../assets/images/image copy 14.png')}
        ...
        <View style={styles.expectSection}>
          ...
          <View style={styles.expectGrid}>
            {/* Box 1: Wide Range of EVs */}
            <View style={styles.expectCard}>
              <Ionicons name="bicycle" size={26} color="#F2CA50" />
              <Text style={styles.expectCardText}>Wide Range of EVs</Text>
            </View>

            {/* Box 2: Flexible Rentals */}
            <View style={styles.expectCard}>
              <Ionicons name="calendar-outline" size={26} color="#F2CA50" />
              <Text style={styles.expectCardText}>Flexible Rentals</Text>
            </View>

            {/* Box 3: Affordable Prices */}
            <View style={styles.expectCard}>
              <Ionicons name="wallet-outline" size={26} color="#F2CA50" />
              <Text style={styles.expectCardText}>Affordable Prices</Text>
            </View>

            {/* Box 4: Safe & Reliable */}
            <View style={styles.expectCard}>
              <Ionicons name="shield-checkmark-outline" size={26} color="#F2CA50" />
              <Text style={styles.expectCardText}>Safe & Reliable</Text>
            </View>
          </View>
        </View>
